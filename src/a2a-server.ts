...
const PAYEE_ADDRESS = process.env.X402_PAYEE_ADDRESS || '0xaCB5b32D83c9182a012334c3CC0775098AE1f927';
...
app.get('/.well-known/agent-card.json', async (_req: Request, res: Response) => {
  const agentCard = await import('../.well-known/agent-card.json', { with: { type: 'json' } });
